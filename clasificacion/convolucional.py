...
# Primera Capa
W_conv1 = weight_variable([5, 5, 1, 32]) # Pesos convolucion 1
b_conv1 = bias_variable([32]) # Bias convlucion 1

# Imagen en 2D para Convolucion
x_image = tf.reshape(x, [-1,28,28,1])

# Convolucion de la imagen con los pesos antes definidos
h_conv1 = tf.nn.relu(conv2d(x_image, W_conv1) + b_conv1)
h_pool1 = max_pool_2x2(h_conv1)


# Segunda capa
W_conv2 = weight_variable([5, 5, 32, 64]) # Pesos convolucion 2
b_conv2 = bias_variable([64]) # Bias convlucion 2
